...
public record CadastroOsRequest(long idTecnico, long idSupervisor, long idMaquina, StatusOS statusOS, String descricao, double valorOS, Departamento departamento, TipoOS tipoOS) {
}
